...
<%@ page language="java" import="fudandb.*, java.sql.*" %>
	...
	%>
				...
				<div id="header" class="shell">
					<div id="logo">
						<h1><a href="#">BestSeller</a></h1><span><a href="http://www.lyq.me">Designed by Liang Yongqing</a></span></div>
					<!-- Navigation -->
					<div id="navigation">
						<ul>
					...
					<div id="login-details">
						...
						<p>&nbsp;&nbsp;&nbsp; My Orders</p> <a href="orders.jsp" class="cart"><img src="css/images/cart-icon.png" alt="orders" /></a>
						<script type="text/javascript">
			...
			%>
				...
				%>
									...
									<th>
										<%=results.getString("publish_year")%>
									</th>
									<th>
										<%=results.getInt("copies")%>
									</th>
									<th>
									...
									<th>
										<%=results.getDouble("rate")%>
									</th>
									<th>
										<%=results.getDouble("trust_rate")%>
									</th>
							</tr>
							<%
				}
		...
		%>
							<p>Degree is 1. Share by
								<%=degree.substring(1)%>.</p>
							<%
				} else {
		%>
								<p>Degree is 2. Share by
									<%=degree.substring(1)%>.</p>
								<%
				}
			}
